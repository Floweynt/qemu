...
#define LIMINE_ARCH_X86_64      1
#define LIMINE_ARCH_AARCH64     2
#define LIMINE_ARCH_RISCV64     3
#define LIMINE_ARCH_LOONGARCH64 4

#ifndef LIMINE_TARGET_ARCH
...
#    define LIMINE_TARGET_ARCH LIMINE_ARCH_AARCH64
#  elif defined(__riscv) && (__riscv_xlen == 64)
#    define LIMINE_TARGET_ARCH LIMINE_ARCH_RISCV64
#  elif defined(__loongarch__) && (__loongarch_grlen == 64)
#    define LIMINE_TARGET_ARCH LIMINE_ARCH_LOONGARCH64
#  endif
#endif

#if LIMINE_TARGET_ARCH == LIMINE_ARCH_X86_64
...
#elif LIMINE_TARGET_ARCH == LIMINE_ARCH_AARCH64
...
#elif LIMINE_TARGET_ARCH == LIMINE_ARCH_RISCV64
...
#elif LIMINE_TARGET_ARCH == LIMINE_ARCH_LOONGARCH64
...
#else
#  ifdef LIMINE_TARGET_ARCH
#    error Unsupported LIMINE_TARGET_ARCH value
#  else
#    error Unknown architecture (define LIMINE_TARGET_ARCH to override)
#  endif
#endif
